...
```html
<!-- fx-lab effect: vapor — Vaporwave Grid (shader) · license MIT -->
<canvas id="fx-vapor" style="display:block;width:100%;height:100%;min-height:240px"></canvas>
<script type="module">
