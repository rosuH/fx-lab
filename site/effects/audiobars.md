...
> Simulated spectrum bars pulse in blue-green gradient (no mic); energetic audio-visualiser look.

- **id**: `audiobars` · **kind**: canvas · **section**: interaction-and-generative
- **tags**: oscilloscope, lines, geometry, canvas2d · **vibe**: energetic, technical
- **culture**: —
...
```html
<!-- fx-lab effect: audiobars — Audio Bars (canvas) · license MIT -->
