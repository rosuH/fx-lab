...
```html
<!-- fx-lab effect: voronoi — Voronoi Cells (shader) · license MIT -->
<canvas id="fx-voronoi" style="display:block;width:100%;height:100%;min-height:240px"></canvas>
<script type="module">
